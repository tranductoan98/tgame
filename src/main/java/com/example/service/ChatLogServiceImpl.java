...
public class ChatLogServiceImpl implements ChatLogService{
	...
	public Page<ChatLog> getChatByMap(int mapId, Pageable pageable) {
		...
		return chatLogRepository.findByMap_MapidOrderBySentatDesc(mapId, pageable);
	}
	...
	public List<ChatLog> getLatestChatInMap(int mapId, int limit) {
        ...
        return chatLogRepository.findByMap_MapidOrderBySentatDesc(mapId, pageable).getContent();
	}
